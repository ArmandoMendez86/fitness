      ...
      <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
          <div class="d-flex justify-content-end">
            <span class="icon-copy ti-save pr-3" id="ventaMembresia"></span><span
              class="icon-copy ti-close"
              id="cancelarVentaMembresia"></span>
          </div>
          <div class="clearfix">
            <div class="pull-left">
              <h4 class="text-blue h4">Venta de membresía</h4>
