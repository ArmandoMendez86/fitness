  ...
  <div class="header">
    ...
    <div class="header-right">
      ...
      <div class="github-link">
        <a href="https://github.com/dropways/deskapp" target="_blank"><img src="frontend/vendors/images/github.svg" alt="" /></a>
      </div>
    </div>
  </div>
  ...
  <div class="left-side-bar">
    <div class="brand-logo">
      <a href="#!" class="justify-content-center">
        <img src="frontend/vendors/images/logo.jpg" width="70" />
      </a>
        ...
        <ul id="accordion-menu">
          ...
          <li>
            <a href="servicios.html" class="dropdown-toggle no-arrow">
              <span class="micon bi bi-diagram-3"></span><span class="mtext">Membresías</span>
            </a>
          </li>
          <li>
            <a href="detalle_servicios.html" class="dropdown-toggle no-arrow">
              <span class="micon bi bi-calendar4-week"></span><span class="mtext">Registro Membresías</span>
            </a>
          </li>
        </ul>
      </div>
